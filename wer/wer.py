...
if __name__ == '__main__':
    filename1 = '/home/tyf/api/api_test/testdata/测试文书/传唤证/常玮平传唤通知.jpg_2018-08-15_15-37-23.txt'
    filename2 = '/home/tyf/api/api_test/testdata/测试文书/传唤证/恥松.txt'
    # filename1 ='/home/tyf/gits/tools/wer/hypothesis.txt'
    # filename2 = '/home/tyf/gits/tools/wer/reference.txt'

    fref = codecs.open(filename1, 'r', encoding='utf-8').readlines()
    fpred = codecs.open(filename2, 'r', encoding='utf-8').readlines()
